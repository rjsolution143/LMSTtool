...
{
	Result Prompt(string title, string type, string text);

	Result Prompt(string title, string type, string text, string imagePath);

	DialogResult MessageBox(string title, string content, MessageBoxButtons ButtonType, MessageBoxIcon IconType);

	DialogResult MessageBox(string title, string content, MessageBoxButtons ButtonType, MessageBoxIcon IconType, bool isTopmost);
